...
const PLEX_READ_TOOLS = ["search_all_media", "list_plex_libraries", "get_plex_library_status", "search_plex_library_section", "get_plex_metadata_children", "get_plex_tv_season", "get_service_health"] as const;
